...
import { TAvailableAction } from "@shared/gre/gre-types"
...
@injectable()
@singleton()
export class CoachingSnapshotTransform implements ICoachingSnapshotTransform {
  constructor(@inject(ICardDbService) private cardDbService: ICardDbService) {}
